...
def plot_confidence_interval(x_data, y_data, color='C0', label=None):
    ...
    _x_data, _y_data = organize_data(x_data, y_data)
...
for test_function_name in function_names:        
    ...
    for rep in range(nreps):
        ...
        if genetic_programming:
            ...
            error_gp_all.append([])
            train_error_gp_all.append([])
            val_error_gp_all.append([])
            ...
            for train_target_num in range(num_train_targets):
                ...
                train_error_gp_all[-1].extend(train_error_gp)
                val_error_gp_all[-1].extend(val_error_gp)
        ...
        if equation_engineer:
            ...
            train_error_ee_all.append(train_error_ee)
            val_error_ee_all.append(val_error_ee)
    ...
    train_error_gp_all = [x for x in train_error_gp_all]
    ...
    if genetic_programming:
        ...
        floating_ops_gp_all = [x[::100] for x in floating_ops_gp_all]
        error_gp_all = [x[::100] for x in error_gp_all]
