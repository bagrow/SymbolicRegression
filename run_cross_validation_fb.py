...
#                                                            timeout=18000, function_evals=float('inf'), base_path=None,
#                                                            num_time_steps=10, sigma=sigma)

timeout = get_computation_time(18000)

test_error = FB.run_function_builder(primitives=['*', '+', '-', '%', 'id2', 'sin2'], terminals=['x0', 'x1', '#f'],
                                     depth=3, dataset=dataset, dataset_test=test,
                                     rep=0, multiple_networks=False, use_cmaes=True, use_nes=False, hidden=[38],
                                     num_partial_fills=6, base_path=None, timeout=timeout,
